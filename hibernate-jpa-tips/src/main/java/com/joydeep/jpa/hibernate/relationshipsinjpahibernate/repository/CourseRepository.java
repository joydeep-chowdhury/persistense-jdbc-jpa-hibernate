...
import com.joydeep.jpa.hibernate.relationshipsinjpahibernate.model.ReviewRating;
...
//	  entityManager.flush();
	...
	public void addReviewsForCourse() {
		...
		Review newReview1 = new Review(ReviewRating.FIVE, "Awesomeness to the power infinity");
		Review newReview2 = new Review(ReviewRating.FOUR, "Greatness unbeatable");
